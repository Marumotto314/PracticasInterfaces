...
public class Principal extends JFrame {
    ...
    {
    	/*
    	 * El botón Help está contenido en botones[17]
    	 */
		try	{
...
//            int ancho = (i == 0) ? 245 : anchoBoton; // EL botón de Resultado será más ancho que todos los demás
            /*
             * Modificamos la línea superior para que nos cambie el tamaño de los botones Resultado, Help y Manual
             */
            int ancho;
            if(i == 0)
            	ancho = 245;
...
//                        }
    ...
    private double resultado() {
        ...
        switch (operacion) {
            ...
            case "/":
            	if(operando1 == 0)
            		JOptionPane.showMessageDialog(ventanaError, "Indeterminación", "División entre cero", JOptionPane.ERROR_MESSAGE);
            	else
            		resultado = operando2 / operando1;
                break;
